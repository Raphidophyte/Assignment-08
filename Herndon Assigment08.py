...
# JHerndon,12.14.2020,Modified code to complete assignment 8.
# Most of the code is taken from the answer key provided by RRoot
# ------------------------------------------------------------------------ #
...
class Product:
    ...
    def product_price(self, value:float):
        ...
        #Methods
    def to_string(self):
        """alias of__str__(),converts product data to string"""
        return self.__str__()
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str):
        """Reads data from a file into a slist of product rows

        :param file_nae: (string) with name file
